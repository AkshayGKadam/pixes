$( document ).ready(function() {
    // document.getElementById('#first_video').muted = false;
});

function video_play(current_video)
{
    $('.reels_video').each(function() {
        $(this).get(0).pause();
    });
...
$(document).ready(function() {
    ...
    $('.section').on('classChange', function() {
        var element = $('.section.active');
        console.log(element.data("id"));
        // $('.reels_video').each(function() {
        //     $(this).get(0).pause();
        // });
        // document.getElementById(element.data("id")).muted = false;
        // document.getElementById(element.data("id")).play();
   });
});