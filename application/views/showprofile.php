<?php  
    $profileurl = base_url('assets/assets/images/banner1.jpg');
    if($userdata->sProfilePhotoUrl != "")
    {
        $profileurl = base_url($userdata->sProfilePhotoUrl);
    }
?>
...
<section class="w3l-blog-single py-5">
    <div class="container py-md-5 py-4">
        <div class="row">
            <div class="col-md-2 left-blog-single pr-lg-4">

            </div>
            <div class="col-md-8 right-blog-single w3l-grids-block-5 pl-lg-5 mb-md-0 mb-5">
                <div class="row">
                    <div class="col-md-4 col-4 right-slide">
                        <img src="<?php echo $profileurl; ?>" class="rounded-circle" alt="Profile Photo">
                        <?php
                            if($userdata->usercode == session_usercode)
                            {
                        ?>
                            <h2 class="profile-camera"><i class="fa fa-plus-circle" onclick="document.getElementById('image').click();" aria-hidden="true"></i></h2>
                        <?php
                            }
                        ?>
                    </div>
                    <div class="col-md-8 col-8 left-slide">
                        <div class="row">
                            <div class="col-md-2 col-2" style="padding-left: 0;padding-right: 0;">
                                <h2>
                                    21
                                </h2>
                                <h5>
                            ...
                            <div class="col-md-5 col-5" style="padding-right: 0;">
                                <h2>
                                    200
                                </h2>
                                <h5>
                ...
                ?>
                    <div class="custome-button">
                        <a href="javascript:void(0);" id="btnedit" class="edit-button">Edit Profile</a>
                    </div>
                <?php                        
                    }
                    else{
                    ...
                    <div class="custome-button">
                        <?php 
                            if($userdata->isFollow){
                                if($userdata->followcode == session_usercode || $userdata->status)
                                {
                                    if($userdata->status)
                                    {
                                    ?>
                                        <div class="row">
                                            <div class="col-6"><a href="<?php echo base_url('chats#'.$userdata->chatcode); ?>" type="button" class="follow-button">Message</a>  </div>
                                            <div class="col-6"><button type="button" disabled class="edit-button">Followed</button></div>
                                        </div>
                                    <?php
                                    }else{
                                    ?>
                                        <button type="button" disabled class="edit-button">Followed</button>
                                    <?php
                                    }
                                ?>
                                <?php
                                ...
                                ?>
                                    <div class="row">
                                        <input type="hidden" id="followid" value="<?php echo $userdata->followid; ?>">
                                        <div class="col-6"><button type="button" id="btnAcceptFollowRequest" class="follow-button">Accept</button>  </div>
                                        <div class="col-6"><button type="button" disabled class="edit-button">Reject</button></div>
                                    </div>
                                <?php
                                }
                        ?>
                        <?php }else{ ?>
                            <button type="button" id="btnfollow" class="follow-button">Follow</button>  
                        <?php } ?>
                    </div>
                <?php                        
                    }
                ...
                <input type="hidden" id="user_code" value="<?php echo $this->uri->segment(2); ?>">
                <input type="file" id="image" accept="image/*,video/*" style="display: none;">
                
                <div class="image-to-edit" id="image-to-edit" style="width: 15%; margin-right: 10px; margin-bottom: 15px;display:none;">
                    <img src="<?php echo base_url('assets/assets/images/blog1.jpg'); ?>" alt="img" id="image-edit-src" style="width: 100%;">
                    <?php //echo $dir ?>
                </div>
                ...
                <!-- gallery section -->
                <section class="w3l-gallery py-0" id="gallery">
                    <div class="container py-md-5 py-4">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class=" item">
                                    <a href="<?php echo base_url('assets/assets/images/g1.jpg'); ?>" data-lightbox="example-set" data-title="Project 1"
                                        class="zoom d-block">
                                        <img class="card-img-bottom d-block" src="<?php echo base_url('assets/assets/images/g1.jpg'); ?>" alt="Card image cap">
                                ...
                                <div class="item mt-4">
                                    <a href="<?php echo base_url('assets/assets/images/g2.jpg'); ?>" data-lightbox="example-set" data-title="Project 2"
                                        class="zoom d-block">
                                        <img class="card-img-bottom d-block" src="<?php echo base_url('assets/assets/images/g2.jpg'); ?>" alt="Card image cap">
                                        <span class="overlay__hover"></span>
                                        <span class="hover-content">
                            ...
                            <div class="col-lg-4 col-sm-6 mt-sm-0 mt-4">
                                <div class="item">
                                    <a href="<?php echo base_url('assets/assets/images/g3.jpg'); ?>" data-lightbox="example-set" data-title="Project 3"
                                        class="zoom d-block">
                                        <img class="card-img-bottom d-block" src="<?php echo base_url('assets/assets/images/g3.jpg'); ?>" alt="Card image cap">
                                        <span class="overlay__hover"></span>
                                        <span class="hover-content">
                            ...
                            <div class="col-lg-4 mt-lg-0 mt-4">
                                <div class="row">
                                    <div class="col-lg-12 col-sm-6 item">
                                        <a href="<?php echo base_url('assets/assets/images/g5.jpg'); ?>" data-lightbox="example-set" data-title="Project 4"
                                            class="zoom d-block">
                                            <img class="card-img-bottom d-block" src="<?php echo base_url('assets/assets/images/g5.jpg'); ?>" alt="Card image cap">
                                            <span class="overlay__hover"></span>
                                            <span class="hover-content">
                                    ...
                                    <div class="col-lg-12 col-sm-6 item mt-lg-4 mt-sm-0 mt-4">
                                        <a href="<?php echo base_url('assets/assets/images/g4.jpg'); ?>" data-lightbox="example-set" data-title="Project 5"
                                            class="zoom d-block">
                                            <img class="card-img-bottom d-block" src="<?php echo base_url('assets/assets/images/g4.jpg'); ?>" alt="Card image cap">
                                            <span class="overlay__hover"></span>
                                            <span class="hover-content">
                        ...
                        <div class="testi-wrap">
                            <div class="client-single active position-1" data-position="position-1">
                                <div class="client-img">
                                    <img src="<?php echo base_url('assets/assets/images/testi4.jpg'); ?>" alt="" />
                                </div>
                                ...
                                <div class="client-comment">
                                    ...
                                    <img src="<?php echo base_url('assets/assets/images/quote.png'); ?>" alt="" />
                                </div>
                            </div>

                            <div class="client-single inactive position-2" data-position="position-2">
                                <div class="client-img">
                                    <img src="<?php echo base_url('assets/assets/images/testi2.jpg'); ?>" alt="" />
                                </div>
                                <div class="client-info">
                                    <h3>Olive Yew</h3>
                                    <p>Subtitle goes here</p>
                            ...
                            <div class="client-single inactive position-3" data-position="position-3">
                                <div class="client-img">
                                    <img src="<?php echo base_url('assets/assets/images/testi1.jpg'); ?>" alt="" />
                                </div>
                                <div class="client-info">
                                    <h3>Maya Didas</h3>
                                    <p>Subtitle goes here</p>
                            ...
                            <div class="client-single inactive position-4" data-position="position-4">
                                <div class="client-img">
                                    <img src="<?php echo base_url('assets/assets/images/testi3.jpg'); ?>" alt="" />
                                </div>
                                <div class="client-info">
                                    <h3>Brock Lee</h3>
                                    <p>Subtitle goes here</p>
                            ...
                            <div class="client-single inactive position-5" data-position="position-5">
                                <div class="client-img">
                                    <img src="<?php echo base_url('assets/assets/images/testi5.jpg'); ?>" alt="" />
                                </div>
                                <div class="client-info">
                                    <h3>Shona Leer</h3>
                                    <p>Subtitle goes here</p>
                            ...
                            <div class="client-single inactive position-6" data-position="position-6">
                                <div class="client-img">
                                    <img src="<?php echo base_url('assets/assets/images/testi6.jpg'); ?>" alt="" />
                                </div>
                                <div class="client-info">
                                    <h3>Dennis Lson</h3>
                                    <p>Subtitle goes here</p>
                            ...
                            <div class="client-single inactive position-7" data-position="position-7">
                                <div class="client-img">
                                    <img src="<?php echo base_url('assets/assets/images/testi7.jpg'); ?>" alt="" />
                                </div>
                                <div class="client-info">
                                    <h3>Jenna John</h3>
                                    <p>Subtitle goes here</p>
                    ...
                    <div class="container py-md-5 py-4">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6">
                                <div class="blog-card-single">
                                    <div class="grids5-info">
                                        <a href="#blog"><img src="<?php echo base_url('assets/assets/images/blog1.jpg'); ?>" alt="" /></a>
                                        <div class="blog-info">
                                            <div class="d-flex align-items-center justify-content-between ">
                                                <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                                    <img class="img-fluid" src="<?php echo base_url('assets/assets/images/testi2.jpg'); ?>" alt="admin"
                            ...
                            <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                                <div class="blog-card-single">
                                    <div class="grids5-info">
                                        <a href="#blog"><img src="<?php echo base_url('assets/assets/images/blog2.jpg'); ?>" alt="" /></a>
                                        <div class="blog-info">
                                            <div class="d-flex align-items-center justify-content-between ">
                                                <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                                    <img class="img-fluid" src="<?php echo base_url('assets/assets/images/testi1.jpg'); ?>" alt="admin"
                            ...
                            <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                                <div class="blog-card-single">
                                    <div class="grids5-info">
                                        <a href="#blog"><img src="<?php echo base_url('assets/assets/images/blog3.jpg'); ?>" alt="" /></a>
                                        <div class="blog-info">
                                            <div class="d-flex align-items-center justify-content-between ">
                                                <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                                    <img class="img-fluid" src="<?php echo base_url('assets/assets/images/testi3.jpg'); ?>" alt="admin"
    ...
    <script src="<?php echo base_url('assets/assets/filerobot-image-editor/filerobot-image-editor.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/assets/filerobot-image-editor/index.js'); ?>"></script>
...
<script>
    ...
    document.getElementById('image').onchange = function (evt) {
        ...
        if (FileReader && files && files.length) {
            ...
            fr.onload = function () {
                document.getElementById('image-edit-src').src = fr.result;
                document.getElementById('image-to-edit').click();
                // document.querySelector('.jrjzYY').click();
            }
