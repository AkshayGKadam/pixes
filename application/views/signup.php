...
<body>
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="#" id="signup_form" method="post">
                  ...
                  <input name="signup" id="btnSignup" class="btn btn-block login-btn mb-4" type="button" value="Save">
                </form>
                <p class="login-card-footer-text">Don you have an account? <a href="<?php echo base_url(); ?>login" class="text-reset">Login here</a></p>
  ...
  <script src="assets/assets/js/api.js"></script>
</body>
</html>
