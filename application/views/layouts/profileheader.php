...
<body>
    ...
    <a class="navbar-brand" href="#index.html">
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="search-right ml-lg-3 custome-right" id="desktop-header">
                ...
                <!-- <div class="search-right ml-lg-3 custome-right" style="right: 110px;">
                    <a href="javascript:void(0);" onclick="fullscreen()">
                        <div class="mode-container">
                            <i class="fa-solid fa-expand" id="screen-expand"></i>
                            <i class="fa-solid fa-compress d-none" id="screen-compress"></i>
                        </div>
                    </a>
                </div> -->
                <div class="search-right ml-lg-3 custome-right" style="right: 75px;">
                    <a href="<?php echo base_url(); ?>chats">
                        <div class="mode-container">
